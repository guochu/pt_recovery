...
for i in range(len(Ds)):
	...
	ax[0].semilogy(gammas, fidelities_mean_i, ls='--', marker=markers[i], color=colors[i], markersize=markersize, linewidth=linewidth, markerfacecolor='none', label=r'D=%s'%D)
...
ax[1].set_ylabel(r'$\bar{f}$', fontsize=fontsize)
